...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { customer: @parcel.customer, eircode: @parcel.eircode, status: @parcel.status } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { customer: @parcel.customer, eircode: @parcel.eircode, status: @parcel.status } }
